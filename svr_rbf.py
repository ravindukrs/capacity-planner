...
def run_svr_rbf(label):
    ...
    if predict_label == 9 or predict_label == 10:
        ...
        for train_index, test_index in kf.split(X):
            gsc = GridSearchCV(
                ...
                param_grid={
                    ...
                    'epsilon': [0.0001, 0.0005, 0.001, 0.005, 0.01, 0.05, 0.1, 0.5, 1, 5, 10, 20, 40, 60, 80, 100, 200,
                                400],
                    'gamma': [0.0001, 0.001, 0.002, 0.005, 0.1, 0.2, 0.4, 0.8, 1.6, 3.2, 6.4]
                },
            ...
            rbf_svr.fit(X[train_index], Y[train_index])

            y_pred = rbf_svr.predict(X[test_index])
        ...
        print("Invalid Parameters for SVR Run Function")
